...
def get_student_by_github(github):
    ...
    # takes in QUERY string from above and replaces last github with github parameter
    # assigns key of 'github' to github account
...
if __name__ == "__main__":
    ...
    db.session.close()
    # closes database connection # good practice
